...
plt.imsave(f"ref_symbol_average_{band_choice}_uprava_width_height.jpg", ref_symbol_int8, cmap="gray")
...
coordinates_to_csv(found_symbol_coordinates, filename=f'found_coordinates_{band_choice}.csv')
...
plt.imsave(f"valid_corr_points_on_image_{band_choice}.jpg", band_int8, cmap="pink")
